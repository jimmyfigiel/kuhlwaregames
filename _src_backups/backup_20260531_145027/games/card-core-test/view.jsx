    ...
    <div className="card-core-test-view">
      <div className="test-header">
        <div>
          ...
          <p>
            Drag cards around the table. Drag from the deck to pull the top card. Drag cards into the discard, hand, single-card slot, or public row. The deck and discard sit to the left of the hand so the hand can expand to the right. Tap a card in the hand to open its full-size view directly. Drag cards out of the hand, or drag them left/right in the hand to reorder them. The hand owner sees card fronts; other viewers see card backs. Drag empty table space to pan the table.
          </p>
        </div>
      ...
      <AreaPanel
        ...
        containers={localState.containers}
