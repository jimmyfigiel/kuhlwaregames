    ...
    <div className="card-core-test-view">
      <div className="test-header">
        <div>
          ...
          <p>
            Drag cards around the table. Drag from the deck to pull the top card. Drag cards into the hand or discard. Drag cards out of the hand, or drag them left/right in the hand to reorder them. The hand owner sees card fronts; other viewers see card backs. Drag empty table space to pan the table.
          </p>
        </div>
