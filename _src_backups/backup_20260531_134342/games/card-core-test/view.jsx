    ...
    <div className="card-core-test-view">
      <div className="test-header">
        <div>
          ...
          <p>
            Drag cards around the table. Tap/click a card to select it. Tap/click the
            selected card again to unselect it. Drag from the deck to pull the top card onto the table. Drag a card onto the discard pile to discard it.
          </p>
        </div>
