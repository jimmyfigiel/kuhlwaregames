...
export const crewTypeProfiles = {
  ...
  bot: {
    ...
    maxStats: { reactions: 6, speed: 8, combatSkill: 5, toughness: 6, savvy: 5 },
    nextRolls: [],
    flags: { earnsXp: false, canUseImplants: false, canUseConsumables: false },
  ...
  soulless: {
    ...
    maxStats: { reactions: 6, speed: 8, combatSkill: 5, toughness: 6, savvy: 5 },
    nextRolls: ["background", "motivation", "class"],
    flags: { earnsXp: true, canUseImplants: false, canUseConsumables: false, injuryTable: "bot" },
  ...
  deConverted: {
    ...
    fixedResults: [{ rollType: "motivation", resultName: "Revenge" }],
    flags: { maxImplants: 3, savvyCannotImprove: true },
  ...
  unityAgent: {
    ...
    maxStats: { reactions: 6, speed: 8, combatSkill: 5, toughness: 6, savvy: 5 },
    nextRolls: ["background", "class"],
    fixedResults: [{ rollType: "motivation", resultName: "Order" }],
    specialRules: [],
  ...
  mysteriousPast: {
    ...
    flags: { ignoreCreationStoryPointBonuses: true },
    specialRules: [],
  ...
  hakshan: {
    ...
    maxStats: { reactions: 6, speed: 8, combatSkill: 5, toughness: 6, savvy: 5 },
    nextRolls: ["background", "class"],
    fixedResults: [{ rollType: "motivation", resultName: "Truth" }],
    specialRules: [],
  ...
  geneticUplift: {
    ...
    maxStats: { reactions: 6, speed: 8, combatSkill: 5, toughness: 6, savvy: 5 },
    nextRolls: ["background", "motivation", "class"],
    flags: { ignoreBackgroundCreditGains: true },
    resources: [{ type: "rival", count: 1, label: "+1 Rival" }],
    specialRules: [],
  ...
  mutant: {
    ...
    fixedResults: [{ rollType: "background", resultName: "Lower Megacity Class" }],
    flags: { cannotRecruit: true, cannotFindPatron: true },
    specialRules: [],
  ...
  assaultBot: {
    ...
    maxStats: { reactions: 6, speed: 8, combatSkill: 5, toughness: 6, savvy: 5 },
    nextRolls: [],
    flags: { earnsXp: false, canUseImplants: false, canUseConsumables: false, savvyCannotImprove: true, ignoreClumsyAndHeavy: true },
  ...
  manipulator: {
    ...
    maxStats: { reactions: 6, speed: 8, combatSkill: 5, toughness: 6, savvy: 5 },
    nextRolls: ["motivation", "class"],
    fixedResults: [{ rollType: "background", resultName: "Bureaucrat" }],
    specialRules: [],
  ...
  primitive: {
    ...
    maxStats: { reactions: 6, speed: 8, combatSkill: 5, toughness: 6, savvy: 5 },
    nextRolls: ["motivation", "class"],
    fixedResults: [{ rollType: "background", resultName: "Primitive or Regressed World" }],
    flags: { noGunSights: true, maxFireRange: "8\"" },
    specialRules: [],
  ...
  emoSuppressed: {
    ...
    maxStats: { reactions: 6, speed: 8, combatSkill: 5, toughness: 6, savvy: 5 },
    nextRolls: ["background", "class"],
    fixedResults: [{ rollType: "motivation", resultName: "Survival" }],
    flags: { maxLuck: 0, neverVoluntarilyLeaves: true },
    specialRules: [],
  ...
  minorAlien: {
    ...
    maxStats: { reactions: 6, speed: 8, combatSkill: 5, toughness: 6, savvy: 5 },
    nextRolls: ["background", "motivation", "class"],
    flags: { reduceCreationCreditsAndStoryPointsBy: 1 },
    pendingEffects: [{ effectType: "abilityUpgradeDiscountRoll", dice: "1D6", label: "Ability upgrade discount roll", status: "pending" }],
    specialRules: [],
  ...
  traveler: {
    ...
    nextRolls: ["background", "class"],
    fixedResults: [{ rollType: "motivation", resultName: "Truth" }],
    resources: [{ type: "storyPoint", count: 2, label: "+2 Story Points" }, { type: "questRumor", count: 2, label: "+2 Quest Rumors" }],
    specialRules: [],
  ...
  bioUpgrade: {
    ...
    maxStats: { reactions: 6, speed: 8, combatSkill: 5, toughness: 6, savvy: 5 },
    nextRolls: ["background", "motivation", "class"],
    flags: { maxImplants: 4, canBenefitFromDuplicateImplants: true, reduceCreationCreditsBy: 2 },
    specialRules: [],
...
function withProfileDetails(entry) {
  ...
  return {
    ...
    fixedResults: profile.fixedResults,
    resources: profile.resources,
    pendingEffects: profile.pendingEffects,
    flags: profile.flags,
    saves: profile.saves,
...
function buildFollowUpCommandsForProfile({ crewMemberId, crewMemberNumber, profileKey }) {
  ...
  const fixedResultCommands = buildFixedCharacterCreationResultCommands({
    crewMemberId,
    crewMemberNumber,
    fixedResults: profile?.fixedResults || [],
  });
  const rolledResultCommands = buildCharacterCreationRollCommands({
    crewMemberId,
    crewMemberNumber,
    rollTypes: nextRolls,
